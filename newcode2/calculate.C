...
int InputCurve(const double x, const double Q0){
  ...
  for (int ib = 0; ib < 50; ib++){
    ...
    error = sqrt(pow(fu[1] - fu[2], 2) + pow(fu[3] - fu[4], 2) + pow(fu[5] - fu[6], 2) + pow(fu[7] - fu[8], 2)) / 2.0;
    fprintf(fQ0, "%.3E\t%.3E\t%.3E\t%.3E\t%.3E\t%.3E\t%.3E\t%.3E\t%.3E\t%.3E\t%.3E\n",
	    b, fu[0], error, fu[1], fu[2], fu[3], fu[4], fu[5], fu[6], fu[7], fu[8]);
  }
  fclose(fQ0);
  return 0;
}
...
int EvolvedCurve(const double x, const double b, const double Q0){
  ...
  for (int iQ = 0; iQ < 87; iQ++){
    ...
    error = sqrt(pow(fu[1] - fu[2], 2) + pow(fu[3] - fu[4], 2) + pow(fu[5] - fu[6], 2) + pow(fu[7] - fu[8], 2)) / 2.0;
    fprintf(fQ, "%.3E\t%.3E\t%.3E\t%.3E\t%.3E\t%.3E\t%.3E\t%.3E\t%.3E\t%.3E\t%.3E\n",
	    Q, fu[0], error, fu[1], fu[2], fu[3], fu[4], fu[5], fu[6], fu[7], fu[8]);
  }
  fclose(fQ);
  return 0;
}
